...
#        n_nan = np.isnan(Temp[:,:,step_level[k]]).sum()
#        n_nan = np.count_nonzero(~ix_nan)
#        n_nan = n_pixels - sum(sum(~np.isnan(Temp[:,:,step_level[k]])))
#        n_nan = sum(sum(ix_nan==np.nan))

#        print k, n_pixels,n_nan 
#	 print Temp[:,:,step_level[k]]
#        print ix_nan
#        print count
